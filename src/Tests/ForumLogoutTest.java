...
public class ForumLogoutTest {

    @Test
    void ForumLogoutTest1() {
...
//        options.addArguments("incognito");
        ...
        ForumLogout.getLogout(driver);
        ForumLogout.clickLogout(driver);

//        if (driver.getCurrentUrl().equals("https://www.mycity.rs/index.php?logout=1&"))
//            System.out.println("Test je uspesan! Uspesno smo se log-outovali :) ");
//        else {
//            System.out.println("Test je neuspesan! Neuspesno smo se log-outovali! ");
//        }

        boolean result;
        result = ForumLogIn.ValidateURL(driver, "https://www.mycity.rs/index.php?logout=1&");
