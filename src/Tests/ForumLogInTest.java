...
//        if (driver.getCurrentUrl().equals("https://www.mycity.rs/profile.php?mode=editprofile"))
//            System.out.println("Test je uspesan! Uspesno smo se log-inovali :) ");
//        else {
//            System.out.println("Test je neuspesan! Neuspesno smo se log-inovali! ");
//        }

        boolean result;
        result = ForumLogIn.ValidateURL(driver, "https://www.mycity.rs/profile.php?mode=editprofile");
        // ocekujem da mi se vrati true jer ocekujem da bude na istoj stranici
        // opcija koja postoji takodje je assertFalse
        // u zagradi je actual
        // zbog preglednosti sam napisao na ovaj nacin uz boolean i result
